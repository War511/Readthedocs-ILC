...
// Config calculator section to make sure that it handles AL details of the calculator. 
...
Once *Save new cluster* is chosen, a new dropdown is available with *Pairwise Configuration*, *Criteria configuration*
